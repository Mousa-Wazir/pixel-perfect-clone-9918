    ...
    <footer id="contact" className="bg-primary text-primary-foreground py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-2xl font-bold mb-4">Bazm Coffee</h3>
            <p className="text-primary-foreground/80 mb-6">
              Serving the finest coffee with love and passion. Visit us for an unforgettable coffee experience.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-primary-foreground/80">hello@bazmcoffee.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-primary-foreground/20 pt-8 text-center">
          <p className="text-primary-foreground/60">
            © {new Date().getFullYear()} Bazm Coffee. All rights reserved. Made with ❤️ and ☕
          </p>
        </div>
      </div>
    </footer>
